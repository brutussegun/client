...
function Statistics() {
  return (
    <>
      <div className="mx-auto container lg:mt-4 lg:mb-4">
        <div className="grid sm:grid-cols-2 p-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          <div className="flex justify-center w-full lg:border-r border-gray-300 py-2">
            <svg
            ...
            <div className="text-gray-800 pl-12 w-1/2">
              <h1 className="font-bold text-2xl tracking-1px">450</h1>
              <h2 className="text-base lg:text-md mt-4 leading-8 tracking-wide">
                Happy Clients.
              </h2>
            </div>
          </div>
          <div className="flex justify-center w-full lg:border-r border-gray-300 py-2">
            ...
            <div className="text-gray-800 w-1/2 pl-12">
              <h1 className="font-bold text-2xl tracking-1px">10+</h1>
              <h2 className="text-base lg:text-md mt-4 leading-8 tracking-wide">
                Insurance Solutions
              </h2>
            </div>
          ...
          <div className="flex justify-center w-full lg:border-r border-gray-300 py-2">
            ...
            <div className="text-gray-800 w-1/2 pl-12">
              <h1 className="font-bold text-2xl tracking-1px">35</h1>
              <h2 className="text-base lg:text-md mt-4 leading-8 tracking-wide">
                Years of Experience
              </h2>
            </div>
          ...
          <div className="flex justify-center w-full py-2">
            ...
            <div className="text-gray-800 w-1/2 pl-12">
              <h1 className="font-bold text-2xl tracking-1px">530</h1>
              <h2 className="text-base lg:text-md mt-4 leading-8 tracking-wide">
                Projects Completed
              </h2>
            </div>
